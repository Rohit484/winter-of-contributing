...
Statement stmt;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try
        {
           int Roll,CONT_NUM,DOB,DOJ;
           String add,name,L_N;
           Roll=Integer.parseInt(jTextField1.getText());
           L_N=jTextField4.getText();
           CONT_NUM=Integer.parseInt(jTextField5.getText());
           DOJ=Integer.parseInt(jTextField6.getText());
           DOB=Integer.parseInt(jTextField7.getText());
           
           add=jTextField2.getText();
           name=jTextField3.getText();
           stmt.executeUpdate("Insert Into IGEC_STUDENT VALUES("+Roll+","+CONT_NUM+","+DOB+","+DOJ+","+add+","+name+","+L_N+")");
